    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* MIDDLE NAVIGATION - DESKTOP (ALWAYS VISIBLE) */}
          <div className="hidden lg:flex items-center gap-1">
            {user?.email ? (
              <>
                ...
                <NavLink to="/dashboard/goals" className={linkStyles}>
              ...
              <>
                <Link to="/" className="relative flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-slate-300 hover:text-emerald-400 hover:bg-emerald-500/5 transition-all duration-300">
                  <Home className="h-4 w-4" />
                  <span>Home</span>
                </Link>
                <Link to="#features" className="relative flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-slate-300 hover:text-emerald-400 hover:bg-emerald-500/5 transition-all duration-300">
                  <Zap className="h-4 w-4" />
                  <span>Features</span>
                </Link>
                <Link to="#pricing" className="relative flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-slate-300 hover:text-emerald-400 hover:bg-emerald-500/5 transition-all duration-300">
          ...
          <div className="hidden lg:flex items-center gap-4">
            {user?.email ? (
              ...
              <>
                <Link 
                  to="/auth/login"
                  className="flex items-center gap-2 px-6 py-2 rounded-xl text-sm font-semibold text-slate-300 hover:text-emerald-300 border border-slate-700/50 hover:border-emerald-500/30 bg-slate-900/30 hover:bg-slate-900/50 transition-all duration-300"
                >
                  <span>Sign In</span>
                </Link>
                <Link 
                  to="/auth/register"
                  className="group flex items-center gap-2 px-6 py-2 rounded-xl bg-gradient-to-r from-emerald-400 to-teal-500 text-sm font-bold text-slate-950 shadow-xl shadow-emerald-500/40 hover:shadow-emerald-500/60 transition-all duration-300 hover:scale-105 active:scale-95"
                >
            ...
            <>
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-red-500/30 bg-red-500/10 hover:bg-red-500/20 py-3 text-sm font-semibold text-red-400 hover:text-red-300 transition-all duration-200"
                >
            ...
            <>
              <div className="flex flex-col gap-2">
                <Link 
                  to="/"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-slate-300 hover:text-emerald-400 hover:bg-emerald-500/10 transition-all duration-200"
                >
              ...
              <div className="flex flex-col gap-3">
                <Link 
                  to="/auth/login"
                  onClick={() => setIsOpen(false)}
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 py-3 text-sm font-semibold text-slate-300 hover:text-emerald-300 transition-all duration-200"
                >
                  <User className="h-5 w-5" />
                  Sign In
                </Link>
                <Link 
                  to="/auth/register"
                  onClick={() => setIsOpen(false)}
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-400 to-teal-500 py-3 text-sm font-bold text-slate-950 shadow-lg shadow-emerald-500/30 transition-all duration-200"
                >
